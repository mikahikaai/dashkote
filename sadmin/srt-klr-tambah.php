...
if (isset($_POST['submit'])) {
  ...
  $query = "INSERT INTO tbl_srt_klr VALUES (NULL, '$no_srt', '$tgl_srt', '$lampiran', '$hal', '$untuk', '$id_bagian', '$namaFileBaru', '$ttd', NULL, '$tgl_input', '$id_user')";
...
<head>
  ...
  <title>Simawar - Tambah Surat Keluar</title>
</head>
            ...
            <div class="card border-top border-0 border-4 border-primary">
              <div class="card-body px-5 pb-5">
                <div class="card-title d-flex align-items-center">
                  ...
                  <h5 class="mb-0 text-primary">Tambah Surat Keluar</h5>
                </div>
                <hr>
                <form class="row g-3" method="POST" target="" enctype="multipart/form-data">
                  <div class="col-12">
                    <label for="no_srt_klr" class="form-label">Nomor Surat :</label>
                    <input type="text" class="form-control" name="no_srt_klr" id="no_srt_klr" placeholder="Nomor Surat Keluar" required>
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    ...
                    <select name="ttd" id="ttd" class="form-select" required>
                      ...
                      ?>
                        <option value="<?= $row_user['id_user'] ?>"><?= $row_user['nm_user'] ?></option>
                      <?php } ?>
                    </select>
                  </div>
