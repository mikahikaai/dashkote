                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex order-actions">
                                                <a href="bagian-edit.php?id=<?= $row_srt['id_bagian'];?>" class="text-light bg-success border-0"><i class='bx bxs-edit'></i></a>
                                                <a href="bagian-hapus.php?id=<?= $row_srt['id_bagian'];?>" class="ms-4 text-light bg-warning border-0" onClick="return confirm('Apakah anda yakin ingin menghapus data ini...?')"><i class='bx bxs-trash'></i></a>
                                            </div>
                                        </td>
                                        <td>
                                            <?= $row_srt['nm_bagian'] ?>
